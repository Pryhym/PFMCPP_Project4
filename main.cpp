...
Project 4: Part 4 / 9
 ...
 2) your powInternal() function should do something like this in its body:         *val = std::pow( *val, arg );
         ...
         std::pow's documentation is found here: https://en.cppreference.com/w/cpp/numeric/math/pow so be sure to include the proper header file listed there.
...
int main() 
{
   //testing instruction 0
    ...
    std::cout << "New value of ft = ft / 0 = " << ft.divide(0.f) << std::endl;
